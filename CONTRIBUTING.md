...
Preserve the [output contract](SPEC.md#output-contract), including the CLI maintenance exception.
Command modules should own parsing and validation, while durable behavior belongs in core modules.
