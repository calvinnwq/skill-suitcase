...
The usual source catalog is `$HOME/repos/skills-catalog`; the CLI is either the installed
...
test -d "$HOME/repos/skills-catalog" && git -C "$HOME/repos/skills-catalog" status --short --branch
```
