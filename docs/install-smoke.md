...
```bash
node dist/src/cli.js targets --source /path/to/skills-catalog --codex-home ~/.codex --claude-skills ~/.claude/skills --hermes-skills ~/.hermes/skills --agents-skills ~/.agents/skills --grok-skills ~/.grok/skills --json
...
node dist/src/cli.js status --source /path/to/skills-catalog --target hermes --hermes-skills ~/.hermes/skills --json
node dist/src/cli.js diff --source /path/to/skills-catalog --target hermes --hermes-skills ~/.hermes/skills --json
