...
`tests/fixtures/skills-catalog/skill-suitcase.yaml` keeps `office-hours` canonical across OpenClaw, Codex, Claude, Hermes, Agents, and Grok.
...
- Hermes, Agents, and Grok plan canonical portable skills when compatibility declares them.
