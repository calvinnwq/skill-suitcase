...
dependency directions, CLI-only process IO, recognized source layers, and thin
CLI and command modules described in [`ARCHITECTURE.md`](ARCHITECTURE.md).
The checker uses the TypeScript AST and emits deterministic, sorted failures.
